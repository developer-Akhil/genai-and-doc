...
api_key = "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"
...
def get_embeddings():
    ...
    embeddings = OpenAIEmbeddings(
        ...
        openai_api_key="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",
...
def get_bill_info(data):
    ...
    client = OpenAI(
        api_key="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",
        base_url="https://openrouter.ai/api/v1"  # example
    )
...
def msg():
    ...
    if bill_info['expense'] != None and int(bill_info['expense']) < int(total_claim_amount) :
        ...
        #llm = ChatOpenAI(model="deepseek/deepseek-chat")
        llm = ChatOpenAI(
